...
struct Road previous = roads[0];

String prevIR = "";
double prevTime = timeCounter;
String currIR = "";
...
//          delay(800);
          ...
          currIR = "in_" + String(i);
          if (currIR == prevIR && timeCounter-prevTime < 400) {
            // ignore
          } else {
            roads[k].carCount++;
            totalCars++;
